...
%Titelseite
\begin{frame}[title blue vertical, picture=images/iris.jpg]
    ...
    \begin{columns}
        ...
        \begin{greenblock}{Example: Iris Dataset}
            \begin{itemize}
                ...
                \item $\boldsymbol{x}^{(i)} \in \mathbb{R}^4$ is the feature
                    vector for the $i^{th}$ sample
                \item $\boldsymbol{y}^{(i)} \in \{0, 1, 2\}$ is the class label
                    for the $i^{th}$ sample
            \end{itemize}
        \end{greenblock}
...
\begin{frame}{Confusion Matrix}
    ...
    \centering{}
    \includegraphics[width=0.45\textwidth]{./images/cm_iris.png}
    % \begin{columns}
    %     \column{\kitthreecolumns}
    %     \centering{}
    %     \includegraphics[width=\textwidth]{./images/cm_iris.png}

    %     \column{\kitthreecolumns}
    %     \centering{}
    %     \includegraphics[width=\textwidth]{images/cm_iris_cols.png}
    % \end{columns}
\end{frame}
